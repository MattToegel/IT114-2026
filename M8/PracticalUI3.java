...
public class PracticalUI3 extends JFrame {
    ...
    public PracticalUI3(String title) {
        ...
        card = new CardLayout();
        // One frame, multiple screens; CardLayout swaps visible panels.
        setLayout(card);
        ...
        pack();
        // Center after pack() so the final computed size is used.
    ...
    private void createChatScreen() {
        ...
        // Pressing Enter in JTextField fires an action event.
        textValue.addActionListener(event -> button.doClick());
    ...
    private void addText(String text, JPanel content) {
        // JEditorPane is used for message display because it supports both plain text now and rich HTML later.
        ...
        // Needed because this panel is already visible inside a JScrollPane:
        // revalidate() runs layout again to include the new message,
        // repaint() refreshes the viewport so the new component is drawn now.
        content.revalidate();
        content.repaint();
    }
