...
import Clicky.Client.Views.ChatGameView;
import Clicky.Client.Views.ChatGameView.GamePaneVisibilityMode;
import Clicky.Client.Views.ConnectionView;
import Clicky.Client.Views.UserDetailsView;
...
public class ClientUI extends JFrame implements IConnectionEvents {
    ...
    public ClientUI() {
        super("MT85 - Client UI"); // replace with your UCID and remove the "(change this)" part
