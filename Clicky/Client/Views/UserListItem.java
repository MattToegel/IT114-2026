...
/**
 * Single user row component with display name and compact ready/turn/points
 * badges.
 */
public class UserListItem extends JPanel {
    ...
    private final JLabel clicksBadge = createBadge("CLK 0", Color.ORANGE, Color.BLACK);
    ...
    public void setClicks(int clicks) {
        clicksBadge.setText("CLK " + clicks);
    }
    ...
    public void setAway(boolean away) {
        ...
        clicksBadge.setForeground(away ? AWAY_TEXT_COLOR : Color.BLACK);
    }
